...
public class Player1Controller : MonoBehaviour
{
    ...
    private void VelocityState()
    {
        ...
        {
            if (Input.GetAxis("Vertical") == 0 && Input.GetAxis("Horizontal") == 0 && !coli2.IsTouchingLayers(edge))
            {
                state = State.idle;
            }
            else if (Input.GetAxis("Vertical") == 0 && Input.GetAxis("Horizontal") != 0 && !coli2.IsTouchingLayers(edge))
            {
                state = State.running;
            }
        }
